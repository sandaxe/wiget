...
export class Modal extends Component {
  ...
  render() {
    ...
    return this.state.open ?
      createPortal(
        <div className={`${styles.modalWrapper} ${this.props.hide ? styles.hideModal : ''}`} data-name="modalContainer" onClick={this.handleClickOutside}>
...
export const ModalHeader = (props) => {
  return (
    <div className={props.noLine ?
      `${props.className} ${styles.noLinemodalHeader}` :
      `${props.className} ${styles.modalHeader}`}>
      {
        props.children
      }
    </div>
